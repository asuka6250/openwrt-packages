...
reaches the network at run time. Save one and upload it from that page like any other file.

| file | size | tile |
|---|---|---|
| `cats.svg` | 77 kB | 870 units square, reads well around 440 px |
| `dinos.svg` | 128 kB | 2048 units square, reads well around 880 px |
